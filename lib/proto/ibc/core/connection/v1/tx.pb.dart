...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenTry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.Any>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $4.Any.create)
    ...
    ..aOM<$5.Height>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $5.Height.create)
    ...
    ..aOM<$5.Height>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $5.Height.create)
  ...
  @$pb.TagNumber(3)
  $4.Any get clientState => $_getN(2);
  @$pb.TagNumber(3)
  set clientState($4.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasClientState() => $_has(2);
  @$pb.TagNumber(3)
  void clearClientState() => clearField(3);
  @$pb.TagNumber(3)
  $4.Any ensureClientState() => $_ensure(2);
  ...
  @$pb.TagNumber(7)
  $5.Height get proofHeight => $_getN(6);
  @$pb.TagNumber(7)
  set proofHeight($5.Height v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasProofHeight() => $_has(6);
  @$pb.TagNumber(7)
  void clearProofHeight() => clearField(7);
  @$pb.TagNumber(7)
  $5.Height ensureProofHeight() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $5.Height get consensusHeight => $_getN(10);
  @$pb.TagNumber(11)
  set consensusHeight($5.Height v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasConsensusHeight() => $_has(10);
  @$pb.TagNumber(11)
  void clearConsensusHeight() => clearField(11);
  @$pb.TagNumber(11)
  $5.Height ensureConsensusHeight() => $_ensure(10);
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgConnectionOpenAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.core.connection.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Version>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $3.Version.create)
    ..aOM<$4.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientState', subBuilder: $4.Any.create)
    ..aOM<$5.Height>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofHeight', subBuilder: $5.Height.create)
    ...
    ..aOM<$5.Height>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consensusHeight', subBuilder: $5.Height.create)
  ...
  @$pb.TagNumber(4)
  $4.Any get clientState => $_getN(3);
  @$pb.TagNumber(4)
  set clientState($4.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasClientState() => $_has(3);
  @$pb.TagNumber(4)
  void clearClientState() => clearField(4);
  @$pb.TagNumber(4)
  $4.Any ensureClientState() => $_ensure(3);

  @$pb.TagNumber(5)
  $5.Height get proofHeight => $_getN(4);
  @$pb.TagNumber(5)
  set proofHeight($5.Height v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasProofHeight() => $_has(4);
  @$pb.TagNumber(5)
  void clearProofHeight() => clearField(5);
  @$pb.TagNumber(5)
  $5.Height ensureProofHeight() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $5.Height get consensusHeight => $_getN(8);
  @$pb.TagNumber(9)
  set consensusHeight($5.Height v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasConsensusHeight() => $_has(8);
  @$pb.TagNumber(9)
  void clearConsensusHeight() => clearField(9);
  @$pb.TagNumber(9)
  $5.Height ensureConsensusHeight() => $_ensure(8);
