...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.applications.transfer.v1'), createEmptyInstance: create)
    ...
    ..pc<$4.DenomTrace>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denomTraces', $pb.PbFieldType.PM, subBuilder: $4.DenomTrace.create)
    ..aOM<$4.Params>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $4.Params.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$4.DenomTrace> get denomTraces => $_getList(1);

  @$pb.TagNumber(3)
  $4.Params get params => $_getN(2);
  @$pb.TagNumber(3)
  set params($4.Params v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasParams() => $_has(2);
  @$pb.TagNumber(3)
  void clearParams() => clearField(3);
  @$pb.TagNumber(3)
  $4.Params ensureParams() => $_ensure(2);
}
